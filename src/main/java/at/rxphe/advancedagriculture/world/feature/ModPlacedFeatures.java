...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> PALM_CHECKED_KEY = createKey("palm_checked");
    ...
    private static ResourceKey<PlacedFeature> createKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(Advancedagriculture.MODID, name));
    }
